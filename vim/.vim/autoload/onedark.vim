...
let s:colors = {
      ...
      \ "comment_light_blue": get(s:overrides, "comment_grey", { "gui": "#5C6370", "cterm": "38", "cterm16": "14" }),
      \ "indent_dark_light_blue": get(s:overrides, "comment_grey", { "gui": "#5C6370", "cterm": "24", "cterm16": "6" }),
